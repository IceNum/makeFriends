...
public class UserDialog  extends Dialog {
    ...
    PeopleDoDialog.OnItemClick onItemClick;

    public UserDialog(Context context,PeopleDoDialog.OnItemClick onItemClick) {
    ...
    public void init() {
        ...
        TextView tvBgxq = (TextView) view.findViewById(R.id.tv_yltx);
        TextView tvJb = (TextView) view.findViewById(R.id.tv_ghtx);
