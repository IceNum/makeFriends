...
package com.people.loveme.view.wheel.wheelview;
...
import com.people.loveme.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.txt_lv4));
		// 设置线宽
