...
public class ZhjhDialog extends Dialog implements View.OnClickListener {
    ...
    public ZhjhDialog(Activity context,int type) {
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_zhjh, null);
        setContentView(view);
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dismiss();
                if (type == 1){ //1 APP主页弹框  2 登录弹框
                    ActivitySwitcher.startFragment(context, LoginFra.class);
                    GlobalBeans.getSelf().getEventCenter().sendType(EventCenter.EventType.EVT_LOGOUT);
                    SharePrefUtil.saveString(context,AppConsts.UID,null);
                    context.finish();
                }
            }
        });
    ...
    private void createOrder() {
        ...
        params.put("order_type", "5");//1=用户充值,2=打赏用户.3=打赏平台 4恋爱指导 5 账号激活
        params.put("detail", "账号激活");
    ...
    private void goAlipay(String orderId) {
        ...
        params.put("title", "账号激活费用");
        params.put("money", "99");
        params.put("desc", "账号激活费用");
