...
import com.people.loveme.actlink.ActDecorator;
import com.people.loveme.actlink.NaviLeftListener;
import com.people.loveme.actlink.NaviLeftText;
import com.people.loveme.actlink.NaviRightDecorator;
import com.people.loveme.actlink.NaviRightListener;
import com.people.loveme.actlink.NaviTitleDecorator;
import com.people.loveme.biz.ActivitySwitcher;
import com.people.loveme.ui.fragment.TitleFragment;
import com.people.loveme.utils.ReflectUtil;
import com.people.loveme.utils.StringUtil;
import com.people.loveme.utils.TypeSafer;
...
//        UMShareAPI.get(this).onActivityResult(arg0, arg1, arg2);
    ...
    protected void onResume() {
        super.onResume();
        GlobalBeans.getSelf().setCurActivity(this);
        if (!fragment.hideLeftArrow()) {
